...
elements with values higher or equal to a and lower or equal to b 
...
/**
 * We have an array of strings arr. We’d like to have a sorted copy of 
 * it, but keep arr unmodified.
 */
describe("copySorted", function () {
    it("return sorted copy with out change original", function () {
        let arr = ["HTML", "JavaScript", "CSS"];
       let sortedValue  =copySorted(arr);
        assert.deepEqual(arr, ["HTML", "JavaScript", "CSS"]);
    });

    it("return sorted copy", function () {
        let arr = ["HTML", "JavaScript", "CSS"];
...
describe("unique", function () {
    ...
    it("for empty input return empty", function () {
        let str=""
        assert.deepEqual(unique(str), "");
    });
});
